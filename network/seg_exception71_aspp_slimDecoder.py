...
from network.xception import xception_71, xception_arg_scope
...
class Segmentator:
    ...
    def network(self, inputs, is_training):
        ...
        with tf.variable_scope('network', reuse=tf.AUTO_REUSE):
            ...
            raw_features = end_points[params['base_architecture'] + '/block1/unit_2/bottleneck_v1/conv3']
            ...
            decode = simple_decoder(features=decode,
