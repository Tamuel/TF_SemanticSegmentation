...
from utils.tf_util import _preprocess_subtract_imagenet_mean, _preprocess_zero_mean_unit_range
from network.resnet_v2 import resnet_v2_50, resnet_v2_101, resnet_v2_101_multi, resnet_arg_scope
from network.resnet_v1_beta import resnet_v1_101_beta, resnet_v1_50_beta
...
class Segmentator:
    ...
    def network(self, inputs, is_training):
        ...
        with tf.name_scope('backbone'):
            ...
            elif params['base_architecture'] == 'resnet_v1_50':
                base_model = resnet_v1_50_beta
            else:
        ...
        with tf.variable_scope('network', reuse=tf.AUTO_REUSE):
            # Pyramid atrous convolution module
    ...
    def model_fn(self, features, labels, mode):
        ...
        labels_flat = tf.where(  # Deselect ignores
